...
const LoginPage = () => {
  ...
  return (
    <div className="w-full h-full flex justify-center items-center flex-col relative">
      ...
      <div 
        className="card justify-start items-center shadow-2xl bg-white w-80 p-6 relative gap-6"
      >

        <Logo 
          image='logo'
          className='w-24 absolute top-[-40px] m-auto  border-accent rounded-full '
        />

        <h3 className=" text-3xl font-bold mt-4 text-base-200">
          Log In
        </h3>
        ...
        <motion.button
          ...
          className='inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm ring-offset-background transition-colors disabled:pointer-events-none disabled:opacity-50 border border-base-100 shadow-2xl hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 bg-card font-bold text-base-300'
        >
