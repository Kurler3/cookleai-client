...
const RecipeRow: React.FC<IProps> = ({
    ...
    return (
        <div 
            className="w-full flex justify-between items-center h-28 gap-4 p-4 min-w-96 overflow-x-auto overflow-y-hidden border border-gray-600 rounded-md shadow-md"
        >
